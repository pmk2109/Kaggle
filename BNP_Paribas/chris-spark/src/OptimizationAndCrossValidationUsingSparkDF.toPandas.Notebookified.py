...
#
print('Load data...')
# /FileStore/tables/dn6hae2c1458867682922/test.csv
# /FileStore/tables/dn6hae2c1458867682922/train.csv

train = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/FileStore/tables/dn6hae2c1458867682922/train.csv')
...
test = sqlContext.read.format('com.databricks.spark.csv').options(header='true').load('/FileStore/tables/dn6hae2c1458867682922/test.csv')
...
# This is where we magically tell spark these are Pandas DF's not Spark DF's.

# NOTE: Looking like we lose parallelism here. Might need to use Spark mllib
#  across the board but at the least going to try using spark DF with the rest
#  of sci kit stuff and see what happens.  Using spark-sklearn
